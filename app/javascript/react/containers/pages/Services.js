...
const Services = props => {
  return (
    <div id="insight-services-page">
      <Header classNameIntro="insight-services-intro" classNameCover="insight-services-cover" headerTitle="Moving Services" headerSubtitle="We treat your belongings with the utmost care" />
      <LocalMovingSection />
